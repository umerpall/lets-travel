...
function disableInputs(input1, input2){
    if(input1.value){
...
imageURL.addEventListener('change', ()=>disableInputs(imageURL, imageFile));
imageFile.addEventListener('change', ()=>disableInputs(imageFile, imageURL));